...
text_result=tk.Text(root, height=2, width=22, font=("Arial", 24), bg= 'gray')
text_result.grid(columnspan=5)

btn_1 = tk.Button(root, text="1", command=lambda: add_to_calculation(1),
                  height=2, width=7, bg= 'gray', font=("Arial", 14))
...
btn_clear = tk.Button(root, text="C", command=clear_field, width=15, bg= 'gray',
                      font=("Arial", 14))
btn_clear.grid(row=6, column=1, columnspan=2)
btn_equals = tk.Button(root, text="=", command= evaluate_calculation, width=15,
